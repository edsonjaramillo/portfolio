...
import { FeedProjectItem } from '@/components/projects/FeedProject';
import { GetStaticProps } from 'next';
import { graphCMSClient, getCategories, CategoryType } from '@/lib/graphcms';
...
//         <LightHouseIcon />
//         <span className='project__lighthousetext'>Lighthouse Report</span>
//       </div>
...
//     <span className='project__metrictitle'>{title}</span>
//     <span className='project__metricvalue'>{value}</span>
//   </div>
// );
...
//       <span className='project__gaugevalue'>{value}</span>
//     </div>
//     <span className='project__gaugetitle'>{title}</span>
//   </div>
// );
...
// const Testimonial = ({ name, quote, position }: any) => {
//   return (
//     <div className='project__testimonial'>
//       <blockquote>
//         <q className='project__quote'>{quote}</q>
//       </blockquote>
//       <div className='project__persongroup'>
//         <cite className='project__author'>{name}</cite>
//         <span className='project__position'>{position}</span>
//       </div>
//       <QuoteSVG />
//     </div>
//   );
