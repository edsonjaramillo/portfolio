...
interface ProjectLinks extends ProjectLinkType {
  slug: string;
}

const FeedLinks = ({ github, hasDemo, website, slug }: ProjectLinks) => (
  <div className='feedlinksgrid'>
    {github && <GithubLink href={github} message='Open Repo' />}
    {hasDemo && <DemoLink href={`/project/${slug}/#demo`} message='View Demo' />}
...
const DemoLink = ({ href, message }: IconLinkProps) => (
  <Link href={href}>
    <a className='feedlink__wrapper'>
      <svg
        className='feedlink__icon'
        height='100%'
