    ...
    <>
      <div className='legal responsive-width'>
        ...
        <ul className='legal__list'>
          ...
          <li className='legal__bullet'>
            <p>
              <strong className='legal__strong'>You</strong> means the individual accessing or using
        ...
        <p>
          ...
          obligation under these Terms shall not effect a party&apos; ability to exercise such right
