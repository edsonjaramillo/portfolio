      ...
      <div className='legal responsive-width'>
        ...
        <ul className='legal__list'>
          <li className='legal__bullet'>
            <p>
              <strong className='legal__strong'>Affiliate</strong> means an entity that
          ...
          <li className='legal__bullet'>
            <p>
              <strong className='legal__strong'>Country</strong> refers to: Alabama, United
              States
            </p>
          </li>
          <li className='legal__bullet'>
            <p>
              <strong className='legal__strong'>Company</strong> (referred to as either
              &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
              this Agreement) refers to Google.
            </p>
          </li>
          <li className='legal__bullet'>
            <p>
              <strong className='legal__strong'>Device</strong> means any device that can
          ...
          <li className='legal__bullet'>
            <p>
              <strong className='legal__strong'>Third-party Social Media Service</strong> means
        ...
        <p>
          ...
          limitations may not apply. In these states, each party&apos; liability will be
        ...
        <p>
          Without limiting the foregoing, neither the Company nor any of the company&apos;
        ...
        <p>
          ...
          States government as a &quot;terrorist supporting&quot; country, and (ii) You are not
        ...
        <p>
          ...
          of an obligation under these Terms shall not effect a party&apos; ability to exercise
          such right or require such performance at any time thereafter nor shall the waiver of
        ...
        <p>
          ...
          You on our Service. You agree that the original English text shall prevail in the
          case of a dispute.
        </p>
