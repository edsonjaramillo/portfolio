      ...
      <div className='legal responsive-width'>
        ...
        <ul className='legal__list'>
          <li className='legal__bullet'>
            <p>
              <strong className='legal__strong'>Account</strong> means a unique account created
          ...
          <li className='legal__bullet'>
            <p>
              ...
              this Agreement) refers to {name}.
            </p>
          </li>
          <li className='legal__bullet'>
            <p>
              <strong className='legal__strong'>Cookies</strong> are small files that are
          ...
          <li className='legal__bullet'>
            <p>
              <strong className='legal__strong'>Website</strong> refers to {name}, accessible
              from{' '}
              <a
        ...
        <ul className='legal__list'>
          <li className='legal__bullet'>
            <strong className='legal__strong'>Cookies or Browser Cookies.</strong> A cookie is
        ...
        <ul className='legal__list'>
          ...
          <li className='legal__bullet'>
            <p>
              <strong className='legal__strong'>
        ...
        <ul className='legal__list'>
          ...
          <li className='legal__bullet'>
            <p>
              <strong className='legal__strong'>To contact You:</strong> To contact You by
          ...
          <li className='legal__bullet'>
            <p>
              <strong className='legal__strong'>To provide You</strong> with news, special
              offers and general information about other goods, services and events which we
              offer that are similar to those that you have already purchased or enquired about
          ...
          <li className='legal__bullet'>
            <p>
              <strong className='legal__strong'>For business transfers:</strong> We may use
        ...
        <ul className='legal__list'>
          <li className='legal__bullet'>
            <strong className='legal__strong'>With Service Providers:</strong> We may share
          ...
          <li className='legal__bullet'>
            <strong className='legal__strong'>With business partners:</strong> We may share
            Your information with Our business partners to offer You certain products, services
            or promotions.
          </li>
          <li className='legal__bullet'>
            <strong className='legal__strong'>With other users:</strong> when You share
